...
import 'package:doctor_plant/Fetutres/SocialView/presentation/Widgets/custom_social_item.dart';
...
class CustomListItem extends StatelessWidget {
   const CustomListItem({Key? key, required this.countIndex, required this.name, required this.dateAndTime, required this.text, }) : super(key: key);
